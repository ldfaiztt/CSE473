...
class GreedyBustersAgent(BustersAgent):
  ...
  def chooseAction(self, gameState):
    ...
    for ghostPosBelief in livingGhostPositionDistributions:
      mostPossiblePos = ghostPosBelief.argMax()
      dist = self.distancer.getDistance(pacmanPosition, mostPossiblePos)
      if dist < distToClosestGhost:
        distToClosestGhost = dist
        closestGhostPos = mostPossiblePos
    ...
    for action in legal:
      ...
      if dist < distAfterAction:
        distAfterAction = dist
        nextAction = action
